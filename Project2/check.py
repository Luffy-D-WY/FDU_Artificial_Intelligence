...
if __name__ == "__main__":
    check(language = "English", gold_path="English/test.txt", my_path="example_data/3english_my_result.txt")
    check(language="Chinese",gold_path="Chinese/test.txt",my_path="example_data/3chinese_my_result.txt")